-- Script final pour annulation avec solde - Gestion complète des utilisateurs
...
-- 2. Créer la fonction de gestion des annulations avec création automatique d'utilisateur
...
BEGIN
    ...
    IF NEW.booking_status = 'cancelled' AND OLD.booking_status != 'cancelled' THEN
        ...
        -- Gérer le solde utilisateur avec création automatique si nécessaire
...
SELECT 'Trigger de remboursement configuré avec création automatique utilisateur' AS message;
